...
class DataSet:
    ...
    def get_statistic(self):
        ...
        statistics3 = list(
            filter(lambda a: a[0] in list(statistics4.keys()), [(key, value) for key, value in statistics3.items()]))
...
class Report:
    ...
    def generate_excel(self):
        ...
        for year in self.statistics1.keys():
            ws1.append(
                [year, self.statistics1[year], self.statistics3[year], self.statistics2[year], self.statistics4[year]])
